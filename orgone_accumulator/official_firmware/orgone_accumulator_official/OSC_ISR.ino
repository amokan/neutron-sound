void outUpdateISR(void){
 noInterrupts();   
  ...
  //-----------------------------------------------CHAOS FM MODE OSCILLATORS-----------------------------------------------
  case 2:

    //main oscillator
    o1.phase = o1.phase + (o1.phase_increment+o2.index);
    o1.wave = (FMTable[o1.phase>>23]);
    o1.index = (mixHi_fl * o1.wave);   
    o2.phase = o2.phase +  (o2.phase_increment+o1.index); 
    o2.wave = (sinTable[o2.phase>>23]);
    o2.index = (mixMid_fl * o2.wave);
    o3.phase = o3.phase + (o3.phase_increment+o2.index);    
    o3.wave = (sinTable[o3.phase>>23]);
    o3.index = (mixLo_fl * o3.wave); 
    //o4.index = (FMIndex * o3.wave);  
    o4.phase = o4.phase +  (o4.phase_increment+o3.index+o2.index+o1.index);
    o4.wave = (FMTable[o4.phase>>23]);
    
    //detune osc
    
    o5.phase = o5.phase + (o5.phase_increment+o2.index);
    o5.wave = (FMTable[o5.phase>>23]);
      
    o6.phase = o6.phase +  (o6.phase_increment+o1.index); 
    o6.wave = (sinTable[o6.phase>>23]);
    
    o7.phase = o7.phase + (o7.phase_increment+o2.index);    
    o7.wave = (sinTable[o7.phase>>23]);
    
    o8.phase = o8.phase +  (o8.phase_increment+o3.index+o2.index+o1.index);
    o8.wave = (FMTable[o8.phase>>23]);

   

    AGCtest = ((((o8.wave+o4.wave))*((int)mixDetuneUp))>>15)  +  (((o4.wave*((int)mixDetuneDn))>>14)); //main out and mix detune
    analogWrite(aout2,4095 - AGCtest);
