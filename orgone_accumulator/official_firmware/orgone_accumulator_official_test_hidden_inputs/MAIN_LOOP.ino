void loop() { 
  ...
  Serial.print("A17, Mod freq CV");
  Serial.print("\t");
  Serial.print(AInRawFilter);
  Serial.print("\t");
  Serial.print("A16, position CV");
  Serial.print("\t");
  Serial.print(aInPos);
  Serial.print("\t");
  Serial.print("A12, detune CV");
  Serial.print("\t");
  Serial.print(aInModDetune);
  Serial.print("\t");
  Serial.print("A15, mod index CV");  
  Serial.print("\t");
  Serial.print(aInModIndex);
  Serial.println("\t");
